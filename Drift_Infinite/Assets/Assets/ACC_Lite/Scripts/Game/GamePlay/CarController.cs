...
public class CarController : MonoBehaviour, ISendData, IReceiveData
{
	...
	public float MaxRPM { get { return CarConfig.MaxRPM; } }
	public float MinRPM { get { return CarConfig.MinRPM; } }
	float CutOffRPM { get { return CarConfig.CutOffRPM; } }
	float CutOffOffsetRPM { get { return CarConfig.CutOffOffsetRPM; } }
	public float RpmToNextGear { get { return CarConfig.RpmToNextGear; } }
	public float RpmToPrevGear { get { return CarConfig.RpmToPrevGear; } }
	...
	{
		// Collect data to send over the network
		return new CarNetworkData
		{
	...
	{
		if (data is CarNetworkData carData)
		{
			// Apply received network data
	...
	private void FixedUpdate ()
	{
        ...
        if (driftSystem != null)
        {
	        driftSystem.isDrifting = isCurrentlyDrifting;
        }
